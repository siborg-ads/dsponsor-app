            ...
            <header className="js-page-header fixed top-0 z-20 w-full backdrop-blur transition-colors">
                <div className="flex items-center px-6 py-6 xl:px-24">
                    ...
                    <div className="hidden lg:flex lg:flex-grow lg:items-center lg:justify-between inset-0 z-10 ml-auto items-center">
                        <nav className="navbar w-full">
                            <ul className="flex flex-col lg:flex-row">
                                <li><HeaderNavLink to="/#hot-offers">Buy spaces</HeaderNavLink></li>
                                <li><HeaderNavLink to="/offer/create">Create offer</HeaderNavLink></li>
                                <li><HeaderNavLink to="/marketplace">Marketplace</HeaderNavLink></li>
                                {address && <li><HeaderNavLink to={`/manage/${address}`}>Manage</HeaderNavLink></li>}
                            </ul>
                        </nav>
                ...
                {toggle && (
                    ...
                    <div className="js-mobile-menu flex flex-col items-center bg-white dark:bg-jacarta-800 p-6 lg:hidden h-screen w-full fixed top-0 left-0 z-10">
                        ...
                        {address && <HeaderMobileMenuLink to={`/manage/${address}`}>Manage</HeaderMobileMenuLink>}
                        <ConnectWallet theme="dark" modalSize="wide"/>
