      ...
      {tableData.map((item) => (
        ...
        >
          ...
          <div className="hidden w-2/12 items-center justify-end md:flex" role="cell">
            <span className={item.isIncrease ? "text-green" : "text-red"}>{item.percentage}</span>
          </div>
          <div className="flex w-3/12 items-center justify-end md:w-2/12" role="cell">
          ...
          <div className="hidden w-1/12 items-center justify-end lg:flex" role="cell">
