            ...
            <div className="mb-6 flex flex-col items-center">
              ...
              <div className="mb-6 flex flex-col items-center">
                ...
                <p className="dark:text-jacarta-100 text-jacarta-100 text-2xs mt-3">
                  You&apos;ll earn up to {selectedUnitPrice} {symbolContract ?? selectedCurrency}.
                  As d&gt;sponsor charges a fee of 4%, sponsors will pay{" "}
              ...
              <div className="mb-6 flex flex-col items-center">
                ...
                <p className="dark:text-jacarta-100 text-jacarta-100  text-2xs mb-3">
                  Sponsors can sell an ad space ownership on the marketplace. Define the fee you
                  want to get from secondary sales. Sponsors might refuse to buy an ad space if your
