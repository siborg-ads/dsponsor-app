          ...
          <tr>
            {tableData.map((item) => (
              ...
              >
                ...
                <td className="flex w-3/12 items-center justify-end whitespace-nowrap md:w-2/12">
                ...
                <td className="hidden w-2/12 items-center justify-end md:flex">
                  <span className={item.isIncrease ? "text-green" : "text-red"}>
                    {item.percentage}
                  </span>
                </td>
                <td className="flex w-3/12 items-center justify-end md:w-2/12">
                ...
                <td className="hidden w-1/12 items-center justify-end lg:flex">
