      ...
      <div className="container">
        <div className="items-center justify-between lg:flex lg:space-x-24">
          <div className="lg:w-[45%]">
            <h2 className="mb-6 font-display text-3xl font-medium text-jacarta-900 dark:text-white">
              Need help?
            </h2>
            <p className="mb-6 text-lg dark:text-jacarta-100">
            ...
            <p className="dark:text-jacarta-100">
