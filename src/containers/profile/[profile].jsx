...
const Edit_user = () => {
  ...
  return (
    <div>
      <Meta title="Profil || SiBorg Ads - The Web3 Monetization Solution" />
            ...
            <div className="mx-auto max-w-[48.125rem] md:flex">
              ...
              <div className="mb-12 md:w-1/2 md:pr-8">
                <div className="mb-6">
                  ...
                  <Input type="text" id="profile-username" placeholder="Enter username" required />
                </div>
                <div className="mb-6">
                  <label className="font-display text-jacarta-900 mb-1 block text-sm dark:text-white">
                ...
                <div className="mb-6">
                  ...
                  <Input type="email" id="profile-email" placeholder="Enter email" required />
                </div>
                <div className="mb-6">
                  <label className="font-display text-jacarta-900 mb-1 block text-sm dark:text-white">
                  ...
                  <div className="relative">
                    ...
                    <Input type="text" id="profile-twitter" placeholder="@twittername" />
                  </div>
                  <div className="relative">
                    <svg
                      aria-hidden="true"
                    ...
                    <Input type="text" id="profile-instagram" placeholder="instagramname" />
                  </div>
                  <div className="relative">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <Input type="text" id="profile-website" placeholder="yoursitename.com" />
                  </div>
                </div>
                <div className="mb-6">
                  <label className="font-display text-jacarta-900 mb-1 block text-sm dark:text-white">
