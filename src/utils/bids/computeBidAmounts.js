 ...
 * @param {BigInt} bonusRefundBps - The basis points used to calculate the bonus refund for the previous bidder.
 * @param {BigInt} royaltyBps - The basis points allocated to the creator as a royalty.
 * @param {BigInt} protocolFeeBps - The basis points allocated to the protocol as a fee.
 * 
