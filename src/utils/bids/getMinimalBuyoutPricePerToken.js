 ...
 * 
 * @param {string | number} previousPricePerToken - The price per token from the previous sale or auction.
 *                                                   If not provided or zero, defaults to "0".
 * @param {string | number} buyoutPricePerToken - The buyout price per token for the current auction.
