...
export const getContractNFT = async (nftContractAddress: Address) => {
  const contract = getContract({
    ...
    abi: [
      ...
      {
        anonymous: false,
        inputs: [{ indexed: true, internalType: "bool", name: "allowed", type: "bool" }],
      ...
      {
        inputs: [{ internalType: "bool", name: "_applyTokensAllowlist", type: "bool" }],
        name: "setTokensAllowlist",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function"
      },
