...
const Form = ({ offerId, onUrlChange }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="relative mb-6 rounded-xl">
      <button type="submit" className="absolute right-0 top-0 flex h-full w-12 items-center justify-center rounded-md bg-accent transition-all  hover:bg-accent-dark">
        <span className="  ">
