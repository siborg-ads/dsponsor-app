  ...
  return (
    <section className={classes} id="hot-offers">
      ...
      <div className="container">
        <HeadLine text="Last Offers" image="https://cdn.jsdelivr.net/npm/emoji-datasource-apple@7.0.2/img/apple/64/1f525.png" classes="font-display text-jacarta-700 mb-8 text-center text-3xl dark:text-white" />
