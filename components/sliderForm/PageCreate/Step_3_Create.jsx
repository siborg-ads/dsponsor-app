...
const Step_3_Create = ({ stepsRef, styles, setLink, link, file, handleLogoUpload, previewImage, terms,  setTerms, }) => {
      ...
      <div className="pr-6 pl-2">
        ...
        <div className="mb-6 flex items-center justify-center flex-col">
          ...
          >
            ...
            <div className="dark:bg-jacarta-600 bg-jacarta-50 absolute inset-4 cursor-pointer rounded opacity-0 group-hover:opacity-100 ">
              <FileUploader handleChange={handleLogoUpload} name="file" types={fileTypes} classes="file-drag !max-w-full !min-w-[fit-content]" maxSize={25} minSize={0} />
            </div>
          </div>
        </div>
        {/* <!-- File Upload --> */}
        <div className="mb-6 flex items-center justify-center flex-col">
          ...
          {isSelected && terms.length > 0 ? (
            ...
            <p className="dark:text-jacarta-300 text-jacarta-400 text-2xs mb-3">Drag or choose your terms to upload</p>
          )}
            ...
            >
              <div className={`relative z-10 cursor-pointer px-6`}>
                <div>
                  ...
                  <p className="dark:text-jacarta-300 mx-auto max-w-xs text-xs">PDF Max size: 25 MB</p>
                </div>
              </div>
              <div className="dark:bg-jacarta-600 bg-jacarta-50 absolute inset-4 cursor-pointer rounded opacity-0 group-hover:opacity-100 ">
                <FileUploader handleChange={handleTermsUpload} name="file" types={["PDF"]} classes="file-drag !max-w-full !min-w-[fit-content]" maxSize={25} minSize={0} />
              </div>
            </div>
          ) : (
            <div className="mb-6">
