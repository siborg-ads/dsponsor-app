  ...
  return (
    <section className="relative  pt-24 md:pt-10 h-1527">
      ...
      <picture className="pointer-events-none absolute inset-x-0 top-0 -z-10 hidden dark:block">
        <Image width={1519} height={760} src="/images/gradient_dark.jpg" alt="gradient dark" className="h-full w-full object-cover" />
      </picture>
        ...
        <div className="grid h-full items-center gap-4 ">
          <div className="col-span-6 flex h-full flex-col items-center justify-center py-10 md:items-start md:py-20 xl:col-span-6">
            ...
            <div className="flex space-x-4 justify-center w-full">
              <Link href="/pages/_offer/create" className="bg-accent shadow-accent-volume hover:bg-accent-dark w-36 rounded-full py-3 px-8 text-center font-semibold text-white transition-all">
                Create
              </Link>
              <Link
                href="#hot-offers"
